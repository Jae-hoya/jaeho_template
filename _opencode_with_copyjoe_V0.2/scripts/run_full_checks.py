...
def run_checks(provider: str, port: int, ollama_model: str) -> dict[str, Any]:
    ...
    try:
        ...
        copy_lite_response = _post_json(
            base_url,
            "/api/v1/copy/generate-lite",
            {
        ...
        summary["checks"]["copy_generate_lite"] = copy_lite_response.status_code
        copy_lite_body = copy_lite_response.json()
        summary["copy_lite_language"] = copy_lite_body.get("normalized_request", {}).get("language")
