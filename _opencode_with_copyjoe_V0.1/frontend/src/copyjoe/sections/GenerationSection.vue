...
const emit = defineEmits<{
  generateLite: [payload: GenerateLiteInput]
  refine: [feedback: string]
  resetGeneration: []
}>()

const generationInput = ref("")
const landingUrlInput = ref("")
  ...
  <div class="card">
    ...
    <div class="result-block">
      ...
      <label style="margin-top: 10px">
        렌더링 기준 landing_url (선택)
        <input
          v-model="landingUrlInput"
          :disabled="loadingCopy || loadingLanding || loadingUpload"
      ...
      <p class="muted" style="margin: 8px 0 0">
        landing_url을 넣으면 Playwright 렌더링 텍스트를 컨텍스트로 반영합니다. objective/channel/language는 프롬프트 문맥으로 자동 추론됩니다.
      </p>
    </div>
